...
def plot_fast_timescale():
    """Create fast timescale plot with time series for tau_W=0.125."""
    ...
    # Target tau_W value
    tau_W_target = 0.125
    filename_false = f"homeostasis_False_tau_W_{tau_W_target}"
    filename_true = f"homeostasis_True_tau_W_{tau_W_target}"

    # Panel A: TV distances, tau_W=0.125, No Homeostasis
    ...
    # Panel B: TV distances, tau_W=0.125, With Homeostasis
    ...
    # Panel C: Neuron perplexities, tau_W=0.125, No Homeostasis
    if filename_false in data_dict:
        metrics_false = data_dict[filename_false]
    ...
    # Panel D: Neuron perplexities, tau_W=0.125, With Homeostasis
    if filename_true in data_dict:
        metrics_true = data_dict[filename_true]
    ...
    output_path = figures_dir / "fast_timescale.pdf"
